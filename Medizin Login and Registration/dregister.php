        ...
        <form action="home.php" method="POST">   
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="email" class="form-control form-rounded" id="email" placeholder="E-mail" name="email" required>
            </div>

             <div class="form-group">
                <label for="phone">Phone</label>
                <input type="phone" class="form-control form-rounded" id="phone" placeholder="phone" name="phone" required>
            </div>

            <div class="form-group">
                <label for="Date">Date of Birth</label>
                <input type="date" class="form-control form-rounded" id="date" placeholder="Enter your Date of Birth" name="date" required>
            </div>
            
            <div class="form-group">
                <label for="specialization">Specialization</label>
                <input type="text" class="form-control form-rounded" id="specialization" placeholder="Enter your Specialization" name="specialization" required>
            </div>

            <div class="form-group">
                <label for="hospital">Hospital Name</label>
                <input type="text" class="form-control form-rounded" id="hospital" placeholder="Enter Hospital name" name="hospital" required>
            </div>

            <div class="form-group">
                <label for="address">Address</label>
                <input type="text" class="form-control form-rounded" id="address" placeholder="Enter Hospital address" name="address" required>
            </div>

            <label class="checkbox-inline"><input type="checkbox" required>&emsp;I agree that all details provided by me is true.&emsp;</label>
